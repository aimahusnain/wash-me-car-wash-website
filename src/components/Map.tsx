...
//   return (
//       <div className="bg-primaryBlue-200 lg:grid gap-6 grid-cols-2 px-7 py-6 items-center text-white overflow-hidden">
...
const Map = () => {
  const mobileLocationInfo = useMemo(() => (
    <div className="flex flex-col mb-4 lg:hidden w-full items-center mt-6 justify-center">
      <LocationInfo />
    </div>
  ), []);

  const desktopLocationInfo = useMemo(() => (
    <div className="hidden lg:flex flex-col w-full items-center mt-6 mb-1 justify-center">
      <LocationInfo />
    </div>
  ), []);
